...
//        outStream.close()
    ...
    init {
        ...
        run {
            ...
            f3.nodes[3343.0] = MapNode(300, 228, NodeType.ROOM, 3343, HashMap(), f3)
            f3.nodes[3353.0] = MapNode(320, 228, NodeType.ROOM, 3353, HashMap(), f3)
        ...
        run {
            ...
            f4.nodes[4043.0] = MapNode(755, 901, NodeType.ROOM, 4043, HashMap(), f4)
            ...
            f4.nodes[4053.0] = MapNode(1261, 901, NodeType.ROOM, 4053, HashMap(), f4)
            ...
            f4.nodes[4417.0] = MapNode(2312, 901, NodeType.ROOM, 4417, HashMap(), f4)
            ...
            f4.nodes[4917.0] = MapNode(2729, 901, NodeType.ROOM, 4917, HashMap(), f4)
        ...
        run {
            ...
            f5.nodes[5343.0] = MapNode(752, 885, NodeType.ROOM, 5343, HashMap(), f5)
            ...
            f5.nodes[5353.0] = MapNode(1255, 885, NodeType.ROOM, 5353, HashMap(), f5)
        ...
        run {
            ...
            f6.nodes[6349.0] = MapNode(1067, 876, NodeType.ROOM, 6349, HashMap(), f6)
        ...
        run {
            ...
            f7.nodes[7318.0] = MapNode(669, 304, NodeType.ROOM, 7318, HashMap(), f7)
            ...
            f7.nodes[7363.0] = MapNode(1630, 719, NodeType.ROOM, 7363, HashMap(), f7)
            ...
            f7.nodes[7428.0] = MapNode(2675, 600, NodeType.ROOM, 7326, HashMap(), f7)
            f7.nodes[7431.0] = MapNode(2675, 605, NodeType.ROOM, 7328, HashMap(), f7)
            f7.nodes[7432.0] = MapNode(2675, 637, NodeType.ROOM, 7331, HashMap(), f7)
            f7.nodes[7434.0] = MapNode(2675, 716, NodeType.ROOM, 7334, HashMap(), f7)
            f7.nodes[7433.0] = MapNode(2675, 748, NodeType.ROOM, 7336, HashMap(), f7)
            f7.nodes[7436.0] = MapNode(2675, 794, NodeType.ROOM, 7336, HashMap(), f7)
